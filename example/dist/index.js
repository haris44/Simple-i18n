...
var _properties_FR = __webpack_require__(2);

var _properties_FR2 = _interopRequireDefault(_properties_FR);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_index2.default.import(_properties_FR2.default, ['fr', 'FR']);
_index2.default.init();

console.log(_index2.default.myProps);
...
var foundLang = function foundLang(jsonObj, lang) {
	var t = jsonObj.find(function (el) {
		return el.lang[0] === lang[0] && el.lang[1] === lang[1];
	});
	if (t) return t;else return jsonObj.find(function (el) {
		return el.lang[0] === lang[0];
	});
};

var register = function register(json, lang) {
	jsonArr.push({
		"lang": lang,
		"json": json
	});
...
module.exports = new Proxy({}, {
	get: function get(cible, nom) {
		if (nom === 'import' || nom === 'register') return register;else if (nom === 'init') return init;else if (nom === '__esModule') return false;else {
